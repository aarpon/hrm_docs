# -*- coding: utf-8 -*-
#
# Huygens Remote Manager documentation build configuration file, created by
...
copyright = u'2013-2024, Aaron Ponti, Daniel Sevilla, Niko Ehrenfeuchter, Torsten Stoeter,' \
...
htmlhelp_basename = 'HuygensRemoteManagerdoc'
...
man_pages = [
    ('index', 'huygensremotemanager', u'Huygens Remote Manager Documentation',
     [u'Aaron Ponti, Daniel Sevilla, Niko Ehrenfeuchter, Torsten Stoeter', 'Olivier Burri', 'Felix Meyenhofer', 'Egor Zindy', 'Kevin Namink', 'Joost Oliemans'], 1)
]
...
texinfo_documents = [
  ('index', 'HuygensRemoteManager', u'Huygens Remote Manager Documentation',
   [u'Aaron Ponti, Daniel Sevilla, Niko Ehrenfeuchter, Torsten Stoeter', 'Olivier Burri', 'Felix Meyenhofer', 'Egor Zindy', 'Kevin Namink', 'Joost Oliemans'], 'HuygensRemoteManager', 'One line description of project.',
   'Miscellaneous'),
]
